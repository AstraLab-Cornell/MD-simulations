function datafiles_generator()
for int=0:1:4
filename=sprintf('eq_SYST_%d0001.dat',int);
filename="D:\EMIBF4_equilibration\InternalState\"+filename;
    for KE=10:10:70
            ...
            for ii=0:45:180
                ...
                for Imp_Par=0:6
                    [pos_f] = shift(pos_i,Imp_Par,m,n);
                     ...
                     fname = sprintf('eq_SYST_%d_%d_KE%d_Imp%d_IntState%d0001.dat', phi_z, phi_y,KE,Imp_Par,int);
